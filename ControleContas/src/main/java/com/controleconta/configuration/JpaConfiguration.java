package com.controleconta.configuration;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = "com.controleconta.repo",
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[] { "com.controleconta.model" });
